...
WORKFLOW="/g/scb/zeller/$USER/software/nevermore/from_alignments.nf"
...
nextflow run ${WORKFLOW} \
    -c /g/scb/zeller/$USER/software/nevermore/config/run.config \
    -params-file /g/scb/zeller/$USER/software/nevermore/config/params_run_gq.yml \
    -work-dir ${WORKDIR} \
