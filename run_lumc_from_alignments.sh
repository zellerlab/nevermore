#!/bin/bash
#SBATCH -t 08:00:00
#SBATCH -e gq_%a_%j_err.txt
#SBATCH -o gq_%a_%j_out.txt
#SBATCH --qos=normal
#SBATCH --mem 8G
#SBATCH --no-requeue                                                                                                                                                                                                                                                                                                              
#SBATCH --job-name="gffquant"
...
#WORKFLOW=zellerlab/nevermore/from_alignments.nf
#WORKFLOW_VERSION=test1

# or rely on your own local nevermore repo
WORKFLOW="/exports/archive/lucid-grpzeller-primary/$USER/software/nevermore/from_alignments.nf"
...
nextflow run ${WORKFLOW} \
    -c /exports/archive/lucid-grpzeller-primary/$USER/software/nevermore/config/run.config \
    -params-file /exports/archive/lucid-grpzeller-primary/$USER/software/nevermore/config/params_run_gq.yml \
    -work-dir ${WORKDIR} \
